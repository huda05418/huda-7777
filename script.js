document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Animasi GSAP untuk Konten Utama ---
    gsap.registerPlugin(ScrollTrigger);

    function startMainContentAnimations() {
        // Animasi Section 1 (Home) saat masuk
        ...
        // Animasi Section 2 (About) saat di-scroll
        ...
        // Animasi Section 3 (Tugas) saat di-scroll
        gsap.from(".task-card", {
            scrollTrigger: {
                trigger: '#tugas',
                start: 'top 80%',
